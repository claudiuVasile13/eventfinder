...
<html>
    ...
    <body> 
        ...
        <div id="items">
            <div class="item">
                <img class="wallpaper" src="../img/subway.png" data-toggle="modal" data-target="#modal-popup"/>
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
                        <p class="event">20% off for all sandwichessssssssssssssssssss</p>
                    </div>
                    <div class="icons">
            ...
            <div class="item">
                <img class="wallpaper" src="../img/ramada.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
            ...
            <div class="item">
                <img class="wallpaper" src="../img/hm.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
            ...
            <div class="item">
                <img class="wallpaper" src="../img/mcdonalds.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
            ...
            <div class="item">
                <img class="wallpaper" src="../img/zara.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
            ...
            <div class="item">
                <img class="wallpaper" src="../img/ikea.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
            ...
            <div class="item">
                <img class="wallpaper" src="../img/subway.png" />
                <div class="info">
                    <img src="../img/logo.png">
                    <div class="text">
                        <p class="company">Subway</p>
